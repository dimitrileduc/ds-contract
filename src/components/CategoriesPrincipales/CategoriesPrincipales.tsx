...
export interface CategoriesPrincipalesProps extends Omit<HTMLAttributes<HTMLElement>, 'style'> {
...
export const CategoriesPrincipales = forwardRef<HTMLElement, CategoriesPrincipalesProps>(
  function CategoriesPrincipales(
    { presentation = 'mobile', style = 'superpose', cartes, className, children, ...rest },
    ref,
  ) {
    const classes = [
      styles.root,
