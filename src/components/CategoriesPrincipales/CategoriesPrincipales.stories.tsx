...
/** Every legal combination the contract defines (presentation × style). */
export const Matrix: Story = {
  ...
  render: () => (
    ...
    >
      <CategoriesPrincipales presentation="mobile" style="superpose" />
      <CategoriesPrincipales presentation="mobile" style="empile" />
      <CategoriesPrincipales presentation="tablette" style="superpose" />
      <CategoriesPrincipales presentation="tablette" style="empile" />
      <CategoriesPrincipales presentation="desktop" style="superpose" />
      <CategoriesPrincipales presentation="desktop" style="empile" />
      <CategoriesPrincipales presentation="wide" style="superpose" />
      <CategoriesPrincipales presentation="wide" style="empile" />
    </div>
  ),
};
