...
export const ReviewCard = forwardRef<HTMLElement, ReviewCardProps>(function ReviewCard(
  ...
  return (
    <article
      ref={ref}
      className={classes}
      data-tronque={tronque || undefined}
      data-initiale-visible={initialeVisible || undefined}
      data-photo={photo || undefined}
      data-verifie={verifie || undefined}
      {...rest}
    >
      ...
      {tronque ? <span className={styles.lireLaSuite}>Lire la suite</span> : null}
    </article>
  );
});
