    ...
    <footer ref={ref} className={classes} {...rest}>
      ...
      <div className={styles.Row}>
        <div className={styles.col1}>
          ...
          <Button variant="outlineBlanc" iconLeft={false} iconRight={false}>
            Contactez-nous
          </Button>
        </div>
      ...
      {presentation === 'desktop' ? (
        <div className={styles.LigneBas}>
          ...
          <div className={styles.rseauxSociauxBas}>
            <span
              className={styles.FacebookBas}
              aria-hidden="true"
              dangerouslySetInnerHTML={{ __html: ICONS['facebook'] }}
            />
            <span
              className={styles.InstagramBas}
              aria-hidden="true"
              dangerouslySetInnerHTML={{ __html: ICONS['instagram'] }}
            />
          </div>
