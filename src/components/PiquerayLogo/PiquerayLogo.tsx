  ...
  return (
    <div ref={ref} className={classes} {...rest}>
      <span
        ...
        aria-hidden="true"
        dangerouslySetInnerHTML={{ __html: ICONS['piqueray-logo-marque'] }}
      />
      <span
        className={styles.Wordmark}
        aria-hidden="true"
        dangerouslySetInnerHTML={{ __html: ICONS['piqueray-logo-wordmark'] }}
      />
    </div>
  );
});
