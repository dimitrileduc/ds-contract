...
5. **Given** la section posée, **When** le rédacteur tente d'éditer un élément d'un autre verdict que `éditable` (~~style de carte~~ *(amendé 2026-08-22 : le style est désormais `controlled` au panneau de la section)*, structure, éléments fixés par composition), **Then** le **geste lui-même est bloqué** — pas seulement le panneau absent — conformément à la table validée, et les panneaux natifs Odoo indésirables ne sont pas proposés.
...
- ~~**Le choix de style de carte côté rédacteur** : cette itération fixe le style par composition ; un sélecteur de style éventuel serait une itération future.~~ *(**LEVÉ le 2026-08-22** — l'owner a demandé le sélecteur en session ; livré au panneau de la section. Voir [proofs/amendement-2026-08-22.md](proofs/amendement-2026-08-22.md).)*
...
- ~~**Le style de carte n'est pas un choix rédacteur** (cette itération) : le module Odoo listé par l'owner porte un **sélecteur de colonnes** et un **lien par carte**, pas un sélecteur de style — le style suit la composition de la section posée.~~ *(**HYPOTHÈSE RENVERSÉE le 2026-08-22** par l'owner : le module porte désormais **deux** sélecteurs — colonnes {2,3} et type de carte {superposé, empilé}.)*
