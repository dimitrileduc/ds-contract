const INPUT = {"schemaVersion":"1.0.0","campaignId":"repair-member-card-text-align","fileKey":"d9FYAUcqdcNtsuaMgLefvJ","fileVersionId":"2388960690060214520","run":"second","evidenceRoot":"specs/component-repairs/member-card/run-001","operations":[{"operationId":"center-member-nom","targetId":"member-card","mechanism":"set-properties","nodeId":"2074:2072","structuralPath":"1/0","changes":{"textAlign":{"value":"CENTER"}},"preconditions":[{"field":"masterNodeId","equals":"2074:2072"},{"field":"resolvedNodeId","equals":"2351:35252"},{"field":"nodeType","equals":"TEXT"},{"field":"structuralPath","equals":"1/0"},{"field":"characters","equals":"Cécilia Piqueray"}],"postconditions":[{"field":"characters","equals":"Cécilia Piqueray"}],"source":"campaign.allowlist"},{"operationId":"center-member-poste","targetId":"member-card","mechanism":"set-properties","nodeId":"2074:2072","structuralPath":"1/1","changes":{"textAlign":{"value":"CENTER"}},"preconditions":[{"field":"masterNodeId","equals":"2074:2072"},{"field":"resolvedNodeId","equals":"2351:35349"},{"field":"nodeType","equals":"TEXT"},{"field":"structuralPath","equals":"1/1"},{"field":"characters","equals":"Gérante"}],"postconditions":[{"field":"characters","equals":"Gérante"}],"source":"campaign.allowlist"}],"targets":[{"targetId":"member-card","masterNodeId":"2074:2072","expectedMasterName":"MemberCard","expectedVariantNames":[],"responsiveWidths":[364,320],"subjectKind":"shared-component"}]};
...
const applySetProperties = async (operation) => {
  ...
  if (Object.prototype.hasOwnProperty.call(changes, 'layoutSizingHorizontal')) {
    ...
    if (!['LEFT', 'CENTER', 'RIGHT', 'JUSTIFIED'].includes(changes.textAlign.value)) throw new Error('Text-align value refused: ' + changes.textAlign.value);
