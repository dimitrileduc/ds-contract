# T042 — état de la précondition bloquante FR-005

> Ce document est le **volet précondition** du même relevé ; le reçu vif complet est
> [`recu-vif-photos.md`](recu-vif-photos.md). Il est dupliqué ici parce que T042 demande un
> constat autonome : la précondition se vérifie **avant** de planifier la fenêtre, pas pendant.

**Verdict : la précondition N'EST PAS levée.** La Phase 6 ne démarre pas — et c'est dit,
pas silencieusement sauté.
