# Audit de conformité WCAG 2.2 — page « Portes de garage industrielles »

## Périmètre

`http://localhost:8109/portes-industrielles` · WCAG 2.2 **A et AA** (55 critères) ·
1440, 640 (zoom 200 %), 390, 320 · 2026-09-09 · `@a11y-skills/audit` (axe-core +
10 vérifications) + mesures maison au pixel. Pas de vidéo : batterie lancée directement sur
le site, **11 vérifications, 0 erreur**.
...
|---|---|
| Langue | `fr-BE` |
| Titre de page | « Portes de garage industrielles Hörmann en Province de Liège » — réel |
...
| Images sans description | 4 sur 17 — les légitimes (fonds décoratifs, cartes déjà nommées par leur lien) |
| Ressources en 404 | **0** |

## Les 3 non-conformités — toutes des écarts déjà assumés

Aucune nouveauté. Profil identique à « Portes résidentielles ».

| Critère | Constat mesuré | Décision |
|---|---|---|
| **1.4.3 Contraste** (AA) | Initiales des avis : blanc sur `rgb(155,164,181)`, ratio **2,51** pour 4,5. Seul échec de la page — hero sur photo **8,96**, Devis **8,09**, bouton **20,01**, texte SEO **11,85**. | VOULU |
| **1.4.12 Espacement du texte** (AA) | Deux avis coupés à 3 lignes : 60 px affichés pour 100 réels. | VOULU |
| **1.3.1 Info et relations** (A) | **Un seul saut** (`h2`→`h4`), comme sur Portes résidentielles : pas de carte de catégorie superposée ici. | ACCEPTÉ (04-09) |

## Faux positifs

Identiques aux pages précédentes : le lien d'évitement à 1 × 1 px tant qu'il n'a pas le
focus, et 8 cibles de menu de 16 px couvertes par l'exception d'espacement que l'outil
signale lui-même.
...
qu'il manque aussi des titres : **7 (2 cartes de catégorie empilées, 3 questions de FAQ, titre + sous-titre du texte SEO)** — des textes de 24 à 32 px qui
