...
export const FIGMA_PANEL_LINKS = Object.freeze([
    ...
    Object.freeze({ panelId: "category-card", selector: ".s_pqr_categories_principales [data-pqr-carte]", contractId: "ds.carte-categorie", contractVersion: "3.1.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2692:19667" }),
    ...
    Object.freeze({ panelId: "presentation", selector: ".s_pqr_presentation", contractId: "ds.presentation", contractVersion: "4.2.1", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2693:20805" }),
    Object.freeze({ panelId: "product-card", selector: ".s_pqr_produits_ecommerce [data-pqr-produit]", contractId: "ds.product-card", contractVersion: "4.1.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2763:10149" }),
    Object.freeze({ panelId: "produits-ecommerce", selector: ".s_pqr_produits_ecommerce", contractId: "ds.produits-ecommerce", contractVersion: "2.2.1", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2694:21337" }),
    Object.freeze({ panelId: "realisation-tile", selector: ".s_pqr_realisations [data-pqr-carte]", contractId: "ds.realisation", contractVersion: "2.1.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2095:2484" }),
    Object.freeze({ panelId: "realisations", selector: ".s_pqr_realisations", contractId: "ds.realisations", contractVersion: "1.0.1", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2773:27344" }),
    Object.freeze({ panelId: "reassurances", selector: ".s_pqr_reassurances", contractId: "ds.reassurances", contractVersion: "2.2.1", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2700:26297" }),
