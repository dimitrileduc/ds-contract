...
export const FIGMA_PANEL_LINKS = Object.freeze([
    ...
    Object.freeze({ panelId: "hero", selector: ".s_pqr_hero", contractId: "ds.hero", contractVersion: "1.6.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2111:3382" }),
    ...
    Object.freeze({ panelId: "presentation", selector: ".s_pqr_presentation", contractId: "ds.presentation", contractVersion: "2.6.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2103:2824" }),
    Object.freeze({ panelId: "reassurances", selector: ".s_pqr_reassurances", contractId: "ds.reassurances", contractVersion: "1.3.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2114:3721" }),
    Object.freeze({ panelId: "reassurances-card", selector: ".s_pqr_reassurances [data-pqr-carte]", contractId: "ds.carte", contractVersion: "2.1.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2063:1622" }),
    ...
    Object.freeze({ panelId: "texte-seo", selector: ".s_pqr_texte_seo", contractId: "ds.texte-seo", contractVersion: "2.1.0", status: "available", fileKey: "d9FYAUcqdcNtsuaMgLefvJ", nodeId: "2108:3123" }),
