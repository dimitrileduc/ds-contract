...
{presentation === 'mobile' ? (<Button variant="blanc" iconLeft={false} iconRight iconRightGlyph="arrow-right">Contactez-nous</Button>) : null}
{presentation === 'tablette' ? (<Button variant="outlineBlanc" iconLeft={false} iconRight iconRightGlyph="arrow-right">Contactez-nous</Button>) : null}
</div>
</div>
    </div>
  );
