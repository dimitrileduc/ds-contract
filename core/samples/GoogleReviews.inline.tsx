...
export interface GoogleReviewsProps extends HTMLAttributes<HTMLElement> {
  ...
  avis?: Array<{ auteur: string; initiale: string; date: string; texte: string; tronque: boolean; initialeVisible: boolean; photo: boolean; photoUrl: string; photoAlt: string; verifie: boolean }>;
}
...
<div style={{ ...S.cartes }}>
{montrerControles ? (<div style={{ ...S.flecheGauche }}>
...
<ReviewCard auteur="Prénom N." initiale="P" date="il y a 2 mois" texte="Un témoignage neutre, exemple générique de contenu." initialeVisible photoUrl="" photoAlt="" verifie />
<ReviewCard auteur="Prénom N." initiale="P" date="il y a 3 mois" texte="Un témoignage neutre, exemple générique de contenu." initialeVisible photoUrl="" photoAlt="" verifie />
<ReviewCard auteur="Prénom N." initiale="P" date="il y a 4 mois" texte="Un témoignage neutre, exemple générique de contenu." initialeVisible photoUrl="" photoAlt="" verifie />
<ReviewCard auteur="Prénom N." initiale="P" date="il y a 5 mois" texte="Un témoignage neutre, exemple générique de contenu." initialeVisible photoUrl="" photoAlt="" verifie />
<ReviewCard auteur="Prénom N." initiale="P" date="il y a 6 mois" texte="Un témoignage neutre, exemple générique de contenu." initialeVisible photoUrl="" photoAlt="" verifie />
</div>
{montrerControles ? (<div style={{ ...S.flecheDroite }}>
