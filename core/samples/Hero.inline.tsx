...
export const Hero = forwardRef<HTMLDivElement, HeroProps>(function Hero(
  { sousTitre2 = true, backgroundUrl = '', backgroundAlt = '', titre = [{"text":"Portes de garage","strong":true},{"text":" industrielles"}], sousTitre = [{"text":"La "},{"text":"performance","strong":true},{"text":" sans compromis, même en usage intensif. Atelier, bâtiment industriel, bâtiment public ou résidence : quelle que soit votre application, nous avons "},{"text":"la solution idéale","strong":true},{"text":"."}], style, children, ...rest },
  ref,
) {
  return (
