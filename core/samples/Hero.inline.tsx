 ...
 * Source of truth: contracts/hero.contract.json (ds.hero v3.2.0)
...
const V: Record<string, CSSProperties> = {
  ...
  "presentation-desktop:Voile": {
    ...
    "backgroundImage": "linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0.7) 100%)"
  },
...
<div style={{ ...S.Voile, ...(V[`presentation-${presentation}:Voile`] ?? {}) }}>
