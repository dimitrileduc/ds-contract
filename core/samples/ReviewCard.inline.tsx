...
export const ReviewCard = forwardRef<HTMLElement, ReviewCardProps>(function ReviewCard(
  ...
  return (
    <article ref={ref} style={{ ...S.root, ...style }} data-verifie={verifie || undefined}  {...rest}>
      <div style={{ ...S.entete }}>
<div style={{ ...S.profil }}>
