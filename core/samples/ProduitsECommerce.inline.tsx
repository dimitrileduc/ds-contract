...
{presentation === 'desktop' ? (<Button variant="link" iconLeft={false} iconRight iconLeftGlyph="arrow-left" iconRightGlyph="arrow-right">Voir les produits</Button>) : null}
{presentation === 'wide' ? (<Button variant="link" iconLeft={false} iconRight iconLeftGlyph="arrow-left" iconRightGlyph="arrow-right">Voir les produits</Button>) : null}
</div>
...
<Button variant="link" iconLeft={false} iconRight iconLeftGlyph="arrow-left" iconRightGlyph="arrow-right">Voir les produits</Button>
</div>
    </div>
  );
});
