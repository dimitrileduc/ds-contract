...
const EXPECTED_GRAPH = '0d13598e38ed54b6e0547e6d8b3db6aa89c61624dfcb08fb3ac14e07bd35465d';
const AUTHORING = '3.0.0';
const MODULE = '19.0.1.11.0';
const CONTRACTS: Record<string, string> = { 'ds.google-reviews': '2.0.0', 'ds.presentation': '4.0.1', 'ds.hero': '2.0.0', 'ds.equipe': '1.2.0', 'ds.faq': '1.3.0', 'ds.devis': '2.0.0', 'ds.sav': '2.0.0', 'ds.texte-seo': '3.0.0', 'ds.coordonnees': '2.2.0', 'ds.reassurances': '2.0.0', 'ds.categories-principales': '2.0.0', 'ds.hero-video': '2.0.0', 'ds.produits-ecommerce': '1.0.0' };
