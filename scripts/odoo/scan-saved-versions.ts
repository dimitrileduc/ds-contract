...
const EXPECTED_GRAPH = 'a88621d0ecb0c90e647d68c1fc6c84b5b17dace7c9e79182baca31839893a23b';
const AUTHORING = '3.0.0';
const MODULE = '19.0.1.9.0';
const CONTRACTS: Record<string, string> = { 'ds.google-reviews': '2.0.0', 'ds.presentation': '3.0.0', 'ds.hero': '2.0.0', 'ds.equipe': '1.2.0', 'ds.faq': '1.3.0', 'ds.devis': '1.2.0', 'ds.sav': '1.4.1', 'ds.texte-seo': '3.0.0', 'ds.coordonnees': '2.2.0', 'ds.reassurances': '1.2.0', 'ds.categories-principales': '1.0.0', 'ds.hero-video': '1.0.0', 'ds.produits-ecommerce': '1.0.0' };
