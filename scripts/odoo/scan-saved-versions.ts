...
const EXPECTED_GRAPH = 'c00ad0235a40a4a15d3f2b3e47f30ca3cccd94b5bccb29045b6266e2f2759d12';
const AUTHORING = '1.2.0';
const MODULE = '19.0.1.7.0';
const CONTRACTS: Record<string, string> = { 'ds.google-reviews': '2.0.0', 'ds.presentation': '2.6.0', 'ds.hero': '1.6.0', 'ds.equipe': '1.2.0', 'ds.faq': '1.3.0', 'ds.devis': '1.2.0', 'ds.sav': '1.4.0', 'ds.texte-seo': '2.1.0', 'ds.coordonnees': '2.2.0', 'ds.reassurances': '1.2.0', 'ds.categories-principales': '1.0.0' };
