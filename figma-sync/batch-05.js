...
// Batch sync: Presentation, ProductCard, ProduitsECommerce, Realisation, Reassurances (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
  ...
  },
  {
    ...
    "description": "ProduitsECommerce — generated from contract ds.produits-ecommerce v2.0.0",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
