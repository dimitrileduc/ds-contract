...
// Batch sync: HeroVideo, Hero, MenuEntree, MenuMobile, Presentation, ProductCard (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "HeroVideo",
  ...
  },
  {
    ...
    "description": "Hero — generated from contract ds.hero v3.2.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [
      {
        "property": "SousTitre2",
  ...
  },
  {
    ...
    "description": "Presentation — generated from contract ds.presentation v4.2.1 †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
  ...
  },
  {
    ...
    "description": "ProductCard — generated from contract ds.product-card v4.1.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
