...
// Batch sync: AccordionRow, Avantage, Button, CarouselControls, CarteCategorie, Carte, CategoriesPrincipales, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
