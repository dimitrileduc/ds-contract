...
// Batch sync: AccordionRow, Avantage, Button, CarouselControls, Carte, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
  ...
  },
  {
    ...
    "description": "FooterColumn — generated from contract ds.footer-column v1.0.0",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
  ...
  },
  {
    ...
    "description": "Footer — generated from contract ds.footer v1.0.0",
    "isSet": false,
    "boolProps": [],
    "textProps": [],
    "fontStyles": [
