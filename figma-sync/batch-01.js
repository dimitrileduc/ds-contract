...
// Batch sync: Button, Checkbox, ReviewCard, GoogleReviews, Input, MemberPicture, PiquerayLogo, Select, Textarea (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Button",
