...
// Batch sync: AccordionRow, PiquerayLogo, Avantage, Button, CarouselControls, Carte, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, Footer, Formulaire, ReviewCard (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
