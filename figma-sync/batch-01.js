...
// Batch sync: AccordionRow, Avantage, Button, CarouselControls, Carte, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
