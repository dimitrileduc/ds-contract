...
// Batch sync: AccordionRow, Avantage, Button, CarouselControls, Carte, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
  ...
  },
  {
    ...
    "description": "SectionHeader — generated from contract ds.section-header v2.1.0 †",
    "isSet": true,
    "boolProps": [
      {
        "property": "Accroche2",
