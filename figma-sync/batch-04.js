...
// Batch sync: Formulaire, Notation, ReviewCard, GoogleReviews (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Formulaire",
  ...
  },
  {
    ...
    "stateVariants": [
      {
        "name": "Avatar=Initiale, State=Hover",
        "row": 0,
        "col": 1,
        "spec": {
          "type": "root",
