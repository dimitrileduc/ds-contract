...
// Batch sync: Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Devis",
    "contractId": "ds.devis",
  ...
  },
  {
    ...
    "anchorKey": "cf79e2e8f660aec1cd30185d29b6134b11a86f63",
    "description": "Footer — generated from contract ds.footer v2.0.0 †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
