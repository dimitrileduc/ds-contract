...
// Batch sync: Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, ReviewCard, GoogleReviews, NavItem, Header, Hero (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Select",
