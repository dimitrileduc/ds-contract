...
// Batch sync: Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, Notation (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Coordonnees",
