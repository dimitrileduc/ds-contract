...
// Batch sync: Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, ReviewCard, GoogleReviews, NavItem, Header, Hero, Presentation, ProductCard (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Textarea",
