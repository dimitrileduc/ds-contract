...
// Batch sync: Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, ReviewCard, GoogleReviews, NavItem, Header, Hero, Presentation (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Textarea",
          ...
          "children": [
            {
              ...
              "fixedWidth": {
                "px": 628,
                "varName": "size/presentation/col-gauche"
              },
              "children": [
                {
                  "type":"instance",
