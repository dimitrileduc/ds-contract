...
// Batch sync: Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, Notation, ReviewCard, GoogleReviews (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Equipe",
