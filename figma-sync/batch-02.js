...
// Batch sync: CarteCategorie, Carte, CategoriesPrincipales, Checkbox, SectionHeader, Coordonnees, Copyright, Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "CarteCategorie",
    "contractId": "ds.carte-categorie",
    "anchorKey": "eb623f48fadf36edd0e8a8b818a9dbeb51254e6c",
    "description": "CarteCategorie — generated from contract ds.carte-categorie v2.2.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
        ...
        "spec": {
          ...
          "children": [
            ...
            },
            {
              ...
              "bindings": {
                "itemSpacing": "space/8",
                "paddingLeft": "spacing/card-categorie/pad-h",
                "paddingRight": "spacing/card-categorie/pad-h",
                "paddingTop": "space/32",
                  ...
                  "children": [
                    {
                      ...
                      "children": [
                        ...
                        },
                        {
                          "type": "text",
                          "name": "TexteSuperpose",
                          "characters": "Une porte de garage pour chaque goût et chaque style de maison.",
                          "fontSize": 16,
                          "fontStyle": "Regular",
                          "textFill": "color/blanc",
                          "lineHeight": 24,
    ...
    "stateVariants": [
      {
        "name": "Style=Superpose, State=Hover",
        "row": 0,
        "col": 1,
        "spec": {
          "type": "root",
          ...
          "children": [
            ...
            },
            {
              ...
              "fill": "color/etat/carte-categorie/voile-survol",
              "gradient": {
                "angle": 180,
                "stops": [
                  {
