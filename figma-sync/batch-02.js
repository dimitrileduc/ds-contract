...
// Batch sync: Footer, Formulaire, ReviewCard, GoogleReviews, NavItem, Header, Hero, Presentation, ProductCard, Realisation, Reassurances, SAV, Tab, TexteSEO (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Footer",
