...
// Batch sync: Devis, MemberPicture, MemberCard, Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, Notation (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Devis",
    "contractId": "ds.devis",
    "anchorKey": "ad0f843aa5f283f03f401f9676d0cf1eeb21dcf1",
    "description": "Devis — generated from contract ds.devis v2.0.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
