...
// Batch sync: Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer, Formulaire, Notation, ReviewCard, GoogleReviews, NavItem (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Select",
