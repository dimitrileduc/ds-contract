...
// Batch sync: Formulaire, Notation, ReviewCard, GoogleReviews, NavItem (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Formulaire",
  ...
  },
  {
    ...
    "description": "ReviewCard — generated from contract ds.review-card v4.0.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [
      {
        "property": "Verifie",
