...
// Batch sync: Equipe, FAQ, Input, Select, Textarea, Field, FooterColumn, PiquerayLogo, Footer (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Equipe",
  ...
  },
  {
    ...
    "description": "FAQ — generated from contract ds.faq v2.0.0 †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
