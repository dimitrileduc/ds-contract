...
// Batch sync: ReviewCard, GoogleReviews, GoogleReviewsSection, NavItem, Header, HeroVideo, Hero, Presentation, ProductCard, Realisation, Reassurances, SAV, Tab, TexteSEO (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "ReviewCard",
  ...
  },
  {
    ...
    "description": "SAV — generated from contract ds.sav v1.4.1 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": false,
    "boolProps": [],
    "textProps": [
      {
