...
// Batch sync: Realisations, Reassurances (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "Realisations",
    "contractId": "ds.realisations",
    "anchorKey": "043a3f9354464eebfbb274d5176a67c571e18f87",
    "description": "Realisations — generated from contract ds.realisations v1.0.0",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
    ...
    "variants": [
      {
        "name": "Presentation=Mobile, En-tete=Accroche",
        "row": 0,
        "col": 0,
        "spec": {
          "type": "root",
                  ...
                  "children": [
                    {
                      "type": "text",
                      "name": "Accroche",
                      "characters": "Des installations de qualité",
                      "fontSize": 14,
                      "fontStyle": "Regular",
                    ...
                    },
                    {
                      "type": "text",
                      "name": "Titre",
                      "characters": "Nos réalisations industrielles et installations de qualité",
                      "fontSize": 24,
                      "fontStyle": "Semi Bold",
                      "textFill": "color/noir-bleute",
                      "lineHeight": 30,
      ...
      {
        "name": "Presentation=Mobile, En-tete=Presentation",
        "row": 0,
        "col": 1,
        "spec": {
          "type": "root",
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  "type": "text",
                  "name": "Texte",
                  "characters": "Personnalisez votre porte industrielle grâce à nos solutions sur mesure, parfaitement intégrées à votre façade. Conçues pour recevoir tout type de bardage (Renson, Trespa, Alubond, Bois ou Eternit) ou des sections vitrées, nos portes garantissent une robustesse exceptionnelle et une très longue durée de vie.",
                  "fontSize": 14,
                  "fontStyle": "Regular",
                  "textFill": "color/noir",
                  "lineHeight": 24,
      ...
      {
        "name": "Presentation=Tablette, En-tete=Accroche",
        "row": 1,
        "col": 0,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Presentation=Tablette, En-tete=Presentation",
        "row": 1,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Presentation=Desktop, En-tete=Accroche",
        "row": 2,
        "col": 0,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Presentation=Desktop, En-tete=Presentation",
        "row": 2,
        "col": 1,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Presentation=Wide, En-tete=Accroche",
        "row": 3,
        "col": 0,
        "spec": {
          "type": "root",
      ...
      {
        "name": "Presentation=Wide, En-tete=Presentation",
        "row": 3,
        "col": 1,
        "spec": {
          "type": "root",
  ...
  },
  {
    ...
    "description": "Reassurances — generated from contract ds.reassurances v2.1.1 †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
