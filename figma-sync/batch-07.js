...
// Batch sync: MenuMobile, Presentation, ProductCard, ProduitsECommerce, Realisation (unchanged components skip; changed ones amend in place).
const COMPONENTS = [
  {
    "setName": "MenuMobile",
  ...
  },
  {
    ...
    "description": "ProduitsECommerce — generated from contract ds.produits-ecommerce v2.2.1 †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
  ...
  },
  {
    ...
    "description": "Realisation — generated from contract ds.realisation v2.1.0 · image frame: runtime slot, photo shown is a mockup sample †",
    "isSet": true,
    "boolProps": [],
    "textProps": [],
    "forwardedProps": [],
